...
define([
	...
	"core/js/base/I18N"
], function(dojoDeclare, dojoDom, dojoDomConstruct, dojoDomStyle, dojoOn) {
	return dojoDeclare("core.js.views.AccessLogGrid", null, {
		...
		_createGrid: function() {
			...
			dojoDom.byId(this._id).appendChild(this._accessLogGrid.domNode);
		...
		showAccessLogs: function(/*Object*/ logs) {
			...
			dojoDomStyle.set(this._accessLogGrid.domNode, "visibility", "visible");
